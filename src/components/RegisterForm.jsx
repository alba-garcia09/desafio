...
import { evaluatePasswordStrength } from '../components/passwordUtil.js'; // Importa la función de evaluación

const Container = styled.div`
  width: 80%;
  height: 100%; /* Para ocupar todo el alto de la pantalla */
  margin: 50px 100px; ; /* Centra horizontalmente el contenedor */
  padding: 1.5em;
  ...
  @media (max-width: 767px) {
    width: 90%; /* Un ajuste para pantallas pequeñas */
    margin: 2em auto; /* Asegura que también se centre en dispositivos móviles */
  }
`;
