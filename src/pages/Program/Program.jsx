...
import connectApi from '../../hooks/connectAPI.js'
...
function Tickets() {
  ...
  const { data, getData, error, isLoading } = connectApi();

  useEffect(() => {
    getData({ route: "/workshops/all" });
  }, []);
...
// function Program() {
//   const navigate = useNavigate();
//   const { data: firstDay, getData: getFirstDay, error: firstDayError, isLoading: firstDayLoading } = connectApi();
//   const { data: secondDay, getData: getSecondDay, error: secondDayError, isLoading: secondDayLoading} = connectApi();

//   useEffect(() => {
//     getFirstDay({ route: '/workshops/byDay?day=1' });
//     getSecondDay({ route: '/workshops/byDay?day=2' });
//   }, []);

//   const isLoading = firstDayLoading || secondDayLoading;

//   // Asegurarse de que se llaman todos los hooks antes de retornar
//   if (isLoading) {
//     return <LoadingOverlay isLoading={true} />;
//   }

//   if (firstDayError || secondDayError) {
//     return <div>Error: {firstDayError?.message || secondDayError?.message}</div>;
//   }
...
//           <StyledButton className='minimalButton' active={group === 1 ? 'true' : 'false'} onClick={handleGroup1}>
//   23 de mayo
// </StyledButton>
...
//           <StyledButton className='minimalButton' active={group === 2 ? 'true' : 'false'} onClick={handleGroup1}>
//   24 de mayo
// </StyledButton>
//           </ButtonColumn>
//         </ButtonContainer>
